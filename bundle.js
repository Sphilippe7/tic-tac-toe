...
/***/ function(module, exports, __webpack_require__) {
	...
	var resetgame = function resetgame(event) {
	  event.preventDefault();
	  api.resetgame().then(ui.resetgameSuccess).catch(ui.failure);
	};

	var gamecount = function gamecount(event) {
	  event.preventDefault();
	  api.gamecount().then(ui.gamecountSuccess).catch(ui.failure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var resetgameSuccess = function resetgameSuccess(data) {
	  api.game = data.game;
	  success(data);
	  logic.reset();
	  console.log(data);
	...
	module.exports = {
	  ...
	  gamecountSuccess: gamecountSuccess
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var gameBoardArray = [["box", "box", "box"], ["box", "box", "box"], ["box", "box", "box"]];
	...
	var checkforwinner = function checkforwinner() {
	  ...
	  if (gameBoardArray[0][0] === "x" && gameBoardArray[0][1] === "x" && gameBoardArray[0][2] === "x" || gameBoardArray[1][0] === "x" && gameBoardArray[1][1] === "x" && gameBoardArray[1][2] === "x" || gameBoardArray[2][0] === "x" && gameBoardArray[2][1] === "x" && gameBoardArray[2][2] === "x" || gameBoardArray[0][0] === "x" && gameBoardArray[1][0] === "x" && gameBoardArray[2][0] === "x" || gameBoardArray[0][1] === "x" && gameBoardArray[1][1] === "x" && gameBoardArray[2][1] === "x" || gameBoardArray[0][2] === "x" && gameBoardArray[1][2] === "x" && gameBoardArray[2][2] === "x" || gameBoardArray[0][0] === "x" && gameBoardArray[1][1] === "x" && gameBoardArray[2][2] === "x" || gameBoardArray[0][2] === "x" && gameBoardArray[1][1] === "x" && gameBoardArray[2][1] === "x") {
	    $('.display-winner').text('Player 1 Wins!');
	    disableGame();
	  }

	  if (gameBoardArray[0][0] === "o" && gameBoardArray[0][1] === "o" && gameBoardArray[0][2] === "o" || gameBoardArray[1][0] === "o" && gameBoardArray[1][1] === "o" && gameBoardArray[1][2] === "o" || gameBoardArray[2][0] === "o" && gameBoardArray[2][1] === "o" && gameBoardArray[2][2] === "o" || gameBoardArray[0][0] === "o" && gameBoardArray[1][0] === "o" && gameBoardArray[2][0] === "o" || gameBoardArray[0][1] === "o" && gameBoardArray[1][1] === "o" && gameBoardArray[2][1] === "o" || gameBoardArray[0][2] === "o" && gameBoardArray[1][2] === "o" && gameBoardArray[2][2] === "o" || gameBoardArray[0][0] === "o" && gameBoardArray[1][1] === "o" && gameBoardArray[2][2] === "o" || gameBoardArray[0][2] === "o" && gameBoardArray[1][1] === "o" && gameBoardArray[2][1] === "o") {
	    console.log('O wins');
	...
	var recordMove = function recordMove(box) {
	  var value = void 0,
	      index = void 0,
	      row = void 0,
	      col = void 0;
	...
	var enableGame = function enableGame() {
